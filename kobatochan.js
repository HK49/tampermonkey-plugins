...
if(/prologue|chapter|i-am-the-monarch/.test(window.location.pathname)) {
  ...
  dayNight((function() {
    ...
    waitress('#main, .content-sidebar-wrap, #branding, .wrapper, body, html', { backgroundColor: 'rgb(195, 147, 104)' });
    waitress('#access', { background: 'rgb(195, 147, 104)' });
    waitress('body, btn, #night_btn, #btn_full', { color: 'rgb(246, 200, 182) !important' });
